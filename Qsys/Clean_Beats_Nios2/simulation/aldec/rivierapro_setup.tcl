...
# ACDS 12.1 177 win32 2013.10.16.13:02:59
...
alias elab {
  echo "\[exec\] elab"
  vsim +access +r  -t ps -L work -L RS232_UART -L on_Chip_RAM -L on_Chip_ROM -L nios2_processor -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiii_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneiii $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L RS232_UART -L on_Chip_RAM -L on_Chip_ROM -L nios2_processor -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiii_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneiii $TOP_LEVEL_NAME
}
