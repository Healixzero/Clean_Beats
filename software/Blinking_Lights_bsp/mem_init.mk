...
# Memory: on_Chip_RAM
MEM_0 := Clean_Beats_Nios2_on_Chip_RAM
$(MEM_0)_NAME := on_Chip_RAM
...
$(MEM_0)_HIERARCHICAL_PATH := on_Chip_RAM
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: on_Chip_RAM
on_Chip_RAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: on_Chip_ROM
MEM_1 := Clean_Beats_Nios2_on_Chip_ROM
$(MEM_1)_NAME := on_Chip_ROM
...
$(MEM_1)_START := 0x00003000
$(MEM_1)_END := 0x00003fff
$(MEM_1)_HIERARCHICAL_PATH := on_Chip_ROM
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: on_Chip_ROM
on_Chip_ROM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
